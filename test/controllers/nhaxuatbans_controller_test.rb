...
class NhaxuatbansControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create nhaxuatban" do
    assert_difference('Nhaxuatban.count') do
      post nhaxuatbans_url, params: { nhaxuatban: { diachi: @nhaxuatban.diachi, email: @nhaxuatban.email, ma_nxb: @nhaxuatban.ma_nxb, ten_nxb: @nhaxuatban.ten_nxb, thongtin: @nhaxuatban.thongtin } }
    end
  ...
  test "should update nhaxuatban" do
    patch nhaxuatban_url(@nhaxuatban), params: { nhaxuatban: { diachi: @nhaxuatban.diachi, email: @nhaxuatban.email, ma_nxb: @nhaxuatban.ma_nxb, ten_nxb: @nhaxuatban.ten_nxb, thongtin: @nhaxuatban.thongtin } }
